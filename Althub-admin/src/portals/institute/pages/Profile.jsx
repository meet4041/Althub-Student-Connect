        ...
        <Fragment>
            ...
            <AppShell contentClassName="profile-content-wrapper">
                    <div className="profile-main-container">
                        ...
                        <div className="mb-4">
                            <h1 className="page-header mb-1 institute-page-title">Settings</h1>
                            ...
                            <div className="settings-detail-content">
                                {isDataLoading ? (
                                    ...
                                    <div className="fade-in">
                                        ...
                                        <div className="avatar-master-wrapper">
                                            ...
                                            <div>
                                                ...
                                                <label htmlFor="pImgUpload" className="btn btn-primary btn-sm shadow-sm admin-form-back-btn">Change Logo</label>
                                        ...
                                        <form onSubmit={submitHandler}>
                                            ...
                                            <div className="mt-4 pt-3 border-top">
                                                <button type="submit" className="btn btn-primary px-5 py-2 font-weight-bold" disabled={disable}>
                                    ...
                                    <div className="fade-in">
                                        ...
                                        <form onSubmit={submitHandlerTwo} className="profile-security-form">
                                            ...
                                            <div className="mt-4 pt-3 border-top">
                                                <button type="submit" className="btn btn-primary px-5 py-2 font-weight-bold" disabled={disable2}>
