                ...
                <div id="content" className="content add-post-wrapper">
                    <div className="add-post-container">
                        <div className="d-flex align-items-center justify-content-between mb-3">
                            <div>
                                <h1 className="page-header edit-event-title mb-0">Edit Placement Post</h1>
                                <p className="text-muted small mb-0">Modify content or add new media to your post</p>
                            </div>
                            <Link to="/placement-posts" className="btn btn-light btn-sm font-weight-bold shadow-sm edit-event-back-btn">
                        ...
                        <div className="post-form-card">
                            <form onSubmit={submitHandler} className="d-flex flex-column h-100">
                                ...
                                <div className="post-footer-actions">
                                    <Link to="/placement-posts" className="btn btn-link text-muted mr-3 font-weight-bold">Discard Changes</Link>
                                    <button 
                                        type="submit" 
...
export default PlacementEditPost;
