                            ...
                            <div>
                                <nav aria-label="breadcrumb">
                                    <ol className="breadcrumb mb-1 posts-breadcrumb">
                                        <li className="breadcrumb-item"><Link to="/placement-posts" className="posts-breadcrumb-link">Home</Link></li>
                                        <li className="breadcrumb-item active">Placement Posts</li>
                                    </ol>
                                </nav>
                                <h1 className="page-header posts-header mb-0">Placement Posts</h1>
                            </div>
                            <Link to="/placement-add-post" className="btn btn-primary shadow-sm posts-create-btn">
                                                    ...
                                                    <tr key={elem._id || index} className="post-row">
                                                        ...
                                                        <td className="align-middle text-right pr-5">
                                                            <div className="d-flex justify-content-end">
                                                                <Link to="/placement-edit-post" state={{ post: elem }} className="btn btn-light btn-sm mr-2 shadow-none border post-action-btn">
