    ...
    const submitHandler = (e) => {
        ...
        if (validate()) {
            ...
            axiosInstance({
                ...
                setTimeout(() => navigate('/placement-events'), 1200);
            }).catch((error) => {
                setDisable(false);
                ...
                <div id="content" className="content edit-event-wrapper">
                    <div className="edit-event-container">
                        <div className="d-flex align-items-center justify-content-between mb-3">
                            <div>
                                <h1 className="page-header edit-event-title mb-0">Edit Placement Event</h1>
                        ...
                        <div className="event-form-card">
                            <form onSubmit={submitHandler} className="d-flex flex-column h-100">
                                ...
                                <div className="form-footer-sticky">
                                    <Link to="/placement-events" className="btn btn-link text-muted mr-3 font-weight-bold">Discard Changes</Link>
...
export default PlacementEditEvent;
