                            ...
                            <div>
                                <nav aria-label="breadcrumb">
                                    <ol className="breadcrumb mb-1 alumni-breadcrumb">
                                        <li className="breadcrumb-item"><Link to="/placement-events" className="alumni-breadcrumb-link">Home</Link></li>
                                        <li className="breadcrumb-item active">Add Course</li>
                                    </ol>
                                </nav>
                                <h1 className="page-header alumni-header mb-0">Add Course</h1>
                            </div>
                            <Link to="/placement-events" className="btn btn-light btn-sm font-weight-bold shadow-sm edit-event-back-btn">
                        ...
                        <div className="post-form-card">
                            <form onSubmit={submitHandler} className="d-flex flex-column h-100">
                                ...
                                <div className="post-footer-actions">
                                    <Link to="/placement-events" className="btn btn-link text-muted mr-3 font-weight-bold">Cancel</Link>
...
export default PlacementAddCourse;
