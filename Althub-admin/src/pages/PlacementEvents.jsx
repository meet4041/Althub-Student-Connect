...
const PlacementEvents = () => {
    ...
    const DeleteEvent = () => {
        axiosInstance.delete(`${ALTHUB_API_URL}/api/deleteEvent/${deleteId}`, {
        })
            .then((res) => {
                if (res.data.success) {
                    setAlert(false);
                ...
                <div id="content" className="content events-content-wrapper">
                    <div className="events-container">
                        <div className="events-header">
                            <div>
                                <nav aria-label="breadcrumb">
                                    <ol className="breadcrumb mb-1">
                                        <li className="breadcrumb-item"><Link to="/placement-events">Home</Link></li>
                                        <li className="breadcrumb-item active">Placement Events</li>
                                    </ol>
                                </nav>
                            ...
                            <Link to="/placement-add-event" className="btn-events-create">
                                    ...
                                    <div className="events-grid">
                                        {currentEvents.length > 0 ? currentEvents.map((elem, index) => (
                                            ...
                                            <div className="events-empty">
                                                ...
                                                <Link to="/placement-add-event" className="btn-events-create btn-events-empty">Create Event</Link>
                                            </div>
                                        )}
                                    </div>
                                ) : (
                            ...
                            <div className="events-modal-layout">
                                ...
                                <div className="events-modal-body">
                                    ...
                                    <div className="events-modal-actions">
                                        <button className="events-modal-btn primary" onClick={() => navigate('/placement-edit-event', { state: { data: selectedEvent } })}>
